...
class HICODataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        boxes = torch.zeros(self.max_boxes_per_data*2, 4)
        masks = torch.zeros(self.max_boxes_per_data*2)
        text_embeddings = torch.zeros(self.max_boxes_per_data*2, self.embedding_len)
        image_embeddings = torch.zeros(self.max_boxes_per_data*2, self.embedding_len)
